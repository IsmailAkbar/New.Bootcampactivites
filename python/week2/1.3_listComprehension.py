...
print(f"number of items in the list: {len(aList)}")

for nums in range(len(aList)):

        print(f"aList Index {nums} | {aList[nums]}")

        listAddition.append(aList[nums] + bList[nums])

        print(f"Added items in the respective list {listAddition}")
...
for nums in range(5): # 0,1,2,3,4 ** 2
