...
dKey1 = input("Enter key1: ")

userDetails2[dKey1] = input(f" Enter the value for {dKey1}")
...
keysVals = int(input("Enter the number of key value pairs you want to add to the dictionary "))


keysVals = 5

for dictItems in range(len(keysVals)):
